...
const Home = () => <div className="mt-4"><h2>Bienvenido a SG MAB Control y Gestion</h2><p>Seleccione una opción del menú para comenzar.</p></div>;
  ...
  if (needsUpdate) {
    return (
      <div style={{
        ...
        <small className="mt-4 opacity-50">SG MAB Control y Gestion v{APP_VERSION} → v1.x.x</small>
      </div>
    );
  }
      ...
      <Navbar bg="dark" variant="dark" expand="lg" className="shadow-sm" collapseOnSelect>
        <Container>
          <Navbar.Brand as={Link} to="/">
            SG MAB Control y Gestion <span style={{ fontSize: '0.6em', opacity: 0.6 }}>v{APP_VERSION}</span>
          </Navbar.Brand>
